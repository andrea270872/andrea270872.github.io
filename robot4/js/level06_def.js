function makeLevel(){
   ...
   const LEVEL_NR = 6;
   const GOAL = [1,2,3,1,2]; // 1 tomatoes, 2 salad, 3 ham
   let ACTUAL_GOAL = GOAL.map( n=>n+7 ); // 1->8 salad-leaf, ...
   const NBLOCKS_STARS = [13,11]; // you get 1 star for winning
                           // 13 or less blocks gets you the second star
                           // 11 or less blocks gets you the third star

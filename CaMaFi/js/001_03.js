...
let prepare_001_03 = (playgroundId)=>{
	...
	let initialValue2 = '8';
	parentDiv.innerHTML += 
	`Scrivi un numero tra 0 e 999: <input id="${inputId1}" type="number" size="3" value="${initialValue1}">
	 E poi un altro numero: <input id="${inputId2}" type="number" size="3" value="${initialValue2}">
	 &nbsp Forma normale?<input type="checkbox" id="${inputId3}">
